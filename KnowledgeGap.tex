...
\sout{Significant} Knowledge gaps {\color{red}not only exist in new diseases, but} also exist in some well known maladies {\color{red}or even medical procedures}.  For
