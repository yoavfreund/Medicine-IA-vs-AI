...
Medical cases vary in their complexity. When the human experts do not agree, it is unlikely that IAH will be able to resolve the disagreement. On the other hand, IA is likely to be more helpful on simple cases, where doctors are more likely to agree. However, IAH needs to {\em know} whether the case is easy or hard, so that it gives advice only when useful. How can IAH quantify its own confidence?
...
Unlike AI, IA systems do not aim to replace the HP. Rather,
IA systems aim to help the HP make diagnoses. The IA interacts with the HP, not with the patient. In this way IA can 
