...
active research field from the AI perspective~\cite{sleepHT2020}. As discussed above,
...
such as protocols, books, lectures and journal articles. \yoav{Such models might have the advantage of capturing pattern recognition abilities which are sometimes hard to describe in words.} 

\hautieng{It can serve not only as a passive search engine that can offer more relevant information to healthcare providers when they ask for any, but also an active knowledge provider when it senses what healthcare providers need}. They are
