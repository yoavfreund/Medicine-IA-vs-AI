...
of ECG sensors on the patient's body.

\yoav{Maybe add a figure explaining how ECG sensors should be placed?
Also, what is the correct term? Sensor? Lead? something else?}
...
imortant that the leads be placed correctly on the patient's
body. Several standards for placement have been published:
\cite{goldberger2017clinical} and {\color{blue}international 10–20 EEG
systems} \cite{Klem1999TheTE} \yoav{I would prefer to focus on one
ignal, i.e. ECG. Can we point to competing standard for lead placement
for ECG?}

\st{to recently smart clothing system for telemedicine}
\cite{nesenbergs2016architecture} \yoav{off topic}

It is not always possible to achieve a consistent and precise sensor
placement for biomedical signal collection due to various reasons,
...
\yoav{I would prefer to stick with ECG}
