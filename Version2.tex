...
treatment can be chosen. The ground truth, as in the ``correct
diagnostics'' is almost never revealed, even in hindsite.

When a new patient arrives at a clinique, all diagnostics are
possible. After a physical exam and talking with the patient, many
...
was their correct diagnostics when they first cam in the door.
