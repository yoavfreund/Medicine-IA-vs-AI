...
such as blood pressure, heart rate, {\color{blue}EKG} \yoav{Is the
  placement of the leads something that can now be done without any
  training?}  and temperature. More complex signals such as
