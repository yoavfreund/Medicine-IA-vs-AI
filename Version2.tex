...
\hautieng{One way to confirm the diagnosis is conducting more specific and accurate examinations. However, this is not always an option. Another way is following up the treatment plan. However, even if we have
the {\em best} treatment plan and the
patient improved after the treatment, the cause might have been unrelated to the
treatment. It might be due to a change in diet or reduction in stress.
Moreover, in some cases, there are few or none followup visits and as
a result there is no data as to whether the patient has a lasting
improvement in health. It is thus not always easy to obtain the ground truth diagnosis as labels.}
\input{SignalQuality}
