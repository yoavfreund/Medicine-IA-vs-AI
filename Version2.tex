...
causes of unccertainty. The uncertainty emanates from the medical
devices to cause uncertainty with the medical staff.

Other types of uncertainty are ``top down'' in that their causes lie
in the generation and dissemination of medical knowledge. We brifly
describe two types of top-down uncertainty: knowledge gaps and the
limitation of medical protocols.

``Knowledge gap'' corresponds to limitations of scientific medical
...
tools such as medical protocol are used to ensure uniformity and
consistency between hospital and between doctors and nurses. While
protocols are important, they suffer from some significant limitations
