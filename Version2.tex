...
process that is mostly unconscious where the one correct diagnosis reveals
itself in the doctors mind. {\color{blue}The physician matches what he/she collects from the patient to what he/she knows, and make a medical decision.} \sout{recognition does not lend itself to verbal
description and is therefor hard to debate or document.} \hautieng{My understanding is different -- what you described is "past experience". See if you agreed with my edits} As it
...
\sout{All medical decision making is based on experience, in which we
...
{\color{blue}In both recognition and elimination, past experience plays a role in medical decision making. This experience is based on medical cases as well as knowledge learned from lectures or practice. Usually, it is not easy to verbally describe past experiences, and hence hard to debate or document them. It fills in the medical uncertainty not covered by protocols.
}

IA can aid the doctor both in Recognition and in Elimination. {\color{blue}On the Recognition side, an IA system equipped with a pattern recognition system would help physicians quickly identify the diagnosis or treatment, and suggest possible items that physicians might commonly miss.
%
On the Elimination side, an IA system could help carefully and slowly
eliminate possible choices, so that physicians can focus on the eliminated choices and make the final decision. In both cases, the system might end up in a gray zone with
multiple possibilities, or fail to match any pattern. In this case, it says IDK so that physicians could intervene. Thus system would dramatically help
