...
does not correspond to an objectively measurable fact, rather, it
represents the conclusion drawn by a human diagnostician. We  will
...
collected. The data used in the experiment was {\em
