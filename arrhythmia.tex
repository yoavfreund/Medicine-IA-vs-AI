...
Hannun et al relied on 3 {\em consensus committees}, each with 3 experienced
cardiologists, to define ground truth. A consensus committee
deliberates each recording until they reach a consensus
classification. Note that this type of consensus is very different
...
\yoav{this seems neither here nor there {\color{blue}-- okay.}}
...
\yoav{How many cardiologists in the committee? {\color{blue} -- 9 in total, split into 3 committees. Updated.}}
...
With ground truth labels determined by a cardiologist consensus
  ...
  consensus committees are {\em better} than individual cardiologists,
