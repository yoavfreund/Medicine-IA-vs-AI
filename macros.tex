...
\mdfsetup{middlelinecolor=blue, middlelinewidth=2pt,backgroundcolor=blue!10, roundcorner=10pt, nobreak=true}
...
\newcommand{\block}[3]{\begin{mdframed}[style=#1]\begin{minipage}{\bf #2}\\ #3 \end{minipage} \end{mdframed}}
